...
const settingColumns = [
  ...
  "category_women_image_url",
  "category_men_image_url",
  "category_shoes_image_url",
...
export async function updateSiteSettings(input: Partial<SiteSettingsRecord>, adminId: string) {
  ...
  const next = {
    ...
    category_women_image_url: input.categoryWomen ?? existing.categoryWomen,
    category_men_image_url: input.categoryMen ?? existing.categoryMen,
    category_shoes_image_url: input.categoryShoes ?? existing.categoryShoes,
    category_accessories_image_url: input.categoryAccessories ?? existing.categoryAccessories,
  ...
  const values = [
    ...
    next.category_women_image_url,
    next.category_men_image_url,
    next.category_shoes_image_url,
    next.category_accessories_image_url,
    next.opening_hours,
...
export function normalizeSiteSettingsRow(row: Record<string, unknown> | undefined): SiteSettingsRecord {
  ...
  return {
    ...
    categoryWomen: readText(row.category_women_image_url, envSiteSettings.categoryWomen),
    categoryMen: readText(row.category_men_image_url, envSiteSettings.categoryMen),
    categoryShoes: readText(row.category_shoes_image_url, envSiteSettings.categoryShoes),
    categoryAccessories: readText(row.category_accessories_image_url, envSiteSettings.categoryAccessories),
