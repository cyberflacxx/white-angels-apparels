...
export function TrackOrder() {
  ...
  return (
    <main>
      <Hero title="Where is your order?" subtitle="Enter your order number and phone number to protect private order details." image="/images/hero-track-order.jpg" compact />
      <Section>
