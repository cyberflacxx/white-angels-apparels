...
export function normalizeSiteSettings(value: unknown): SiteSettings {
  ...
  return normalizeSiteSettingsMedia({
    ...
    categoryWomen: readString(payload.categoryWomen, "/images/site/category-women.jpg"),
    categoryMen: readString(payload.categoryMen, "/images/site/category-men.jpg"),
    categoryShoes: readString(payload.categoryShoes, "/images/site/category-shoes.jpg"),
    categoryAccessories: readString(payload.categoryAccessories, "/images/site/category-accessories.jpg"),
